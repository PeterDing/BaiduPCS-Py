...
class BaiduPCSApi:
    ...
    def upload_file(
        ...
        info = self._baidupcs.upload_file(localpath, remotepath, ondup=ondup, callback=callback)
        return PcsFile.from_(info)

    def rapid_upload_file(self, localpath: str, remotepath: str, ondup='overwrite') -> PcsFile:
    ...
    def combine_slices(self, slice_md5s: List[str], remotepath: str, ondup='overwrite') -> PcsFile:
    ...
    def shared_paths(self, shared_url: str, password: Optional[str] = None) -> List[PcsSharedPath]:
    ...
    def list_shared_paths(self, sharedpath: str, uk: int, share_id: int,
                          bdstoken: str) -> List[PcsSharedPath]:
    ...
    def transfer_shared_paths(
        self, remotedir: str, fs_ids: List[int], uk: int, share_id: int, bdstoken: str,
        shared_url: str
    ):
